...
import { postAPIFormData } from "@/app/api";
                ...
                onSubmit={async (values, { setSubmitting }) => {
                  ...
                  if (fileUrl) {
                    ...
                    try {
                      ...
                      const data = await postAPIFormData(values,"ImgDescription");
                      console.log(data);
                      if (data?.code === 200) {
                    ...
                    <Box minHeight="30vh">
                      ...
                      {files && (
                        <Box p={1}>
                          ...
                          >
                          <Image src={URL.createObjectURL(files[0])} alt={files[0].name} width={30} height={30} />
