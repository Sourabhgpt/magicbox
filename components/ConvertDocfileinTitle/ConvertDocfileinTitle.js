  ...
  return (
    <Div>
      <Box display="flex" alignItems="center" mb={2}>
        ...
        Generate contextual alt text in a few clicks with this simple and effective tool!
        </Typography>
      </Box>
            ...
            <Grid item xs={12}>
              <Formik
                ...
                onSubmit={async (values, { setSubmitting }) => {
                  ...
                  console.log(values);
                  try {
                    const data = await postCallingAPI(values,"getContextAlt");
                    console.log(data);
                    if (data?.code === 401) {
                      ...
                      {!fileUrl && (
                        <Box className="textarea-box" p={2}>
                          <Typography variant="h3" className="textarea-heading">
                            Description box for Contextual Alt Text
                          </Typography>
                          <TextField
                            id="outlined-basic"
                            fullWidth
